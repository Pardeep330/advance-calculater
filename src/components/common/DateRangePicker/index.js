      ...
      <Menu as="div" className="relative list_box_active_state " title={title}>
        <div className="flex w-full justify-center">
          <Menu.Button
            ...
            className={`w-full flex items-center !text-[#B1B1B1] outline-none gap-x-1.5 px-3 text-sm font-[500] bg-white rounded-lg ${
              border
                ? " py-1 justify-center "
                : "rounded-full justify-between hover:bg-gray-50 h-[40px] py-2"
            }`}
          >
        ...
        {toggle && (
          ...
          >
            <Menu.Items
              className={`${
                dynamicStyle ? "" : ""
              }  focus:!outline-none text-sm absolute z-40 ${
                className ? className : " lg:min-w-[360px] min-w-[200px]"
              }  lg:right-0  -right-30 top-[38px] shadow-lg !py-2 !mt-3 overflow-auto bg-white  rounded-lg scrollbar`}
            >
              <div className="fffff">
                <div className="">
                    ...
                    {rangeList.map((itm) => {
                      return showcustom == false &&
                        ...
                        <button
                          className={`btn ${
                            range == itm.id
                              ? "bg-[#1E9ABC] !rounded-full text-white"
